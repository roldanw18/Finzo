...
export function CategoryPie({ data }: { data: CategorySlice[] }) {
  ...
  return (
    // @container: adapts to the CARD width, not the viewport — the same chart
    // lives in a 1/3 column on the dashboard and in wide cards elsewhere.
    <div className="@container">
      <div className="flex flex-col items-center gap-5 @md:flex-row">
        <div className="relative h-48 w-48 shrink-0 @md:h-52 @md:w-52">
